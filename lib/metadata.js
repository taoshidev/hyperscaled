...
const BRAND_META = {
  hyperscaled: {
    ...
    siteUrl: process.env.HYPERSCALED_BASE_URL || "https://hyperscaled.trade",
    twitter: "@hyperscaled",
    ogImage: {
      url: "/og.png",
      width: 1200,
  ...
  vanta: {
    ...
    ogImage: {
      ...
      width: 1200,
      height: 600,
      alt: "Vanta Trading — Permissionless Funded Trading on Hyperliquid",
    },
  },
  bitcast: {
    siteName: "Hyperstack",
    ...
    ogImage: {
      url: "/og-hyperfunded.png",
      width: 1200,
      height: 600,
      alt: "Hyperstack — Scaled Perp Trading on Hyperliquid",
    },
  },
  beanstock: {
    siteName: "Beanstock Trading",
    siteUrl: "https://beanstocktrading.com",
    twitter: "@jollygreenmoney",
    ogImage: {
      url: "/og-beanstock.png",
      width: 1200,
      height: 600,
      alt: "Beanstock Trading — Funded Trading on Hyperliquid",
    },
  },
};
