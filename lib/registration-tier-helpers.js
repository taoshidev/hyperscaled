...
/** Free-tier badge copy: live capacity decides Sold Out vs remaining-slots. */
export function freeTierBadgeLabel(freeAtCapacity, freeTierCap) {
  return freeAtCapacity
    ? "Sold Out"
    : `Only ${freeTierCap.toLocaleString()} Available`;
}
