const BRANDS = {
  ...
  bitcast: {
    ...
    parentSite: { label: 'Back to HyperFunded', url: 'https://hyperfunded.co' },
    heroEyebrow: 'Built on Hyperliquid · Powered by HyperFunded',
    heroSub: 'Trade perps on Hyperliquid with access to scaled capital. Keep 100% of eligible performance rewards, and grow your account to $2.5 Million.',
