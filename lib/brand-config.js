const BRANDS = {
  ...
  bitcast: {
    ...
    heroSub: 'Trade perps on Hyperliquid through a Vanta-powered simulated scaled account. Pass the one-step Challenge and scale your simulated account up to $400K.',
    ...
    heroStats: [
      ...
      { value: 'Simulated', label: 'No Funded Account' },
      { value: '$400K', label: 'Max Scale' },
    ],
    // ── Compliance (Vanta AMPA + Bitcast/HyperFunded Marketing Guide) ──
    // Operator + protocol attribution. The Challenge is operated by Vanta
    // (Taoshi VT Services); HyperFunded is an Authorized Marketing Partner.
    operatorName: 'Vanta',
    ...
    compliance: {
      ...
      statusLine:
        'HyperFunded is an Authorized Marketing Partner of Vanta — a Vanta Powered Partner.',
      ...
      disclosures: [
        ...
        'HyperFunded is an Authorized Marketing Partner of Vanta and may receive a marketing fee.',
      ],
      ...
      // §1.2 — reward framing (APPROVAL-GATED; conservative interim wording for Vanta review)
      rewardLine:
        'Vanta retains 0% of eligible performance-based rewards for invited Scaled Trader Program participants. Rewards are based on simulated performance and paid as independent-contractor compensation, not a share of real trading profits.',
      // §1.8 — full Schedule 3.A disclosure block, shown in footer + near checkout
      footerBlock:
        'HyperFunded is an Authorized Marketing Partner of Vanta and offers a Vanta-powered, partner-branded experience. The Vanta Trading Challenge is operated by Vanta and is subject to Vanta’s Terms of Service, Challenge Rules, Offer Terms, and Privacy Policy. Payments are made to Vanta through Vanta-approved payment processors; HyperFunded does not collect payments, handle refunds, or make payout or eligibility decisions. All trading is simulated using simulated assets; no real securities, commodities, forex, cryptocurrency, or other assets are traded on the platform. The Challenge is not an investment, not investment advice, and not a funded or live trading account. Challenge results are hypothetical. Passing a Challenge does not guarantee an invitation to the Scaled Trader Program or any compensation. HyperFunded may receive a marketing fee from Vanta if you purchase through this page. If this page uses “prop firm,” “prop trading,” or similar shorthand, that shorthand refers only to a Vanta-powered simulated prop trading evaluation experience and does not mean HyperFunded or Vanta provides funded accounts, live trading accounts, real trading capital, or guaranteed payouts.',
    },
    ...
    faqOverrides: {
      'what-is-hyperscaled': {
        question: 'What is HyperFunded?',
        answer: 'HyperFunded is an Authorized Marketing Partner of Vanta — a Vanta Powered Partner. It is a Vanta-powered, partner-branded way to take the Vanta Trading Challenge, a simulated trading evaluation operated by Vanta (Taoshi VT Services). You trade on Hyperliquid with your own wallet and your performance is evaluated against a simulated scaled account. There is no funded or live trading account and no real-money payouts. Traders who pass may be invited into Vanta’s Scaled Trader Program, where eligible performance-based rewards are paid as independent-contractor compensation.',
      },
      'countries-eligible': {
      ...
      'what-changes-scaled': {
        answer: 'On a simulated scaled account the profit target is removed, and your drawdown limit increases to 8% (from 5% during the Challenge). Invited Scaled Trader Program participants may receive monthly USDC rewards based on simulated performance, paid by Vanta as independent-contractor compensation. Rewards are not guaranteed.',
      },
      'when-paid': {
        question: 'When and how are rewards paid?',
        answer: 'Rewards apply only to traders invited into Vanta’s Scaled Trader Program after passing the Challenge. Eligible performance-based rewards are calculated at the end of each monthly cycle and paid in USDC by Vanta to your connected wallet as independent-contractor compensation — not a share of real trading profits. Passing a Challenge does not guarantee an invitation to the Scaled Trader Program or any compensation.',
      },
      'profit-split': {
        question: 'How are rewards determined?',
        answer: 'Vanta retains 0% of eligible performance-based rewards for invited Scaled Trader Program participants. Rewards are based on simulated performance and paid as independent-contractor compensation, not a share of real trading profits. Passing a Challenge does not guarantee an invitation to the Scaled Trader Program or any compensation.',
      },
      'profit-target-scaled': {
        question: 'Do I need to hit a profit target to receive rewards?',
        answer: 'No. For invited Scaled Trader Program participants, eligible performance-based rewards are based on simulated performance during the monthly cycle; there is no minimum profit target. Rewards are independent-contractor compensation paid by Vanta and are not guaranteed.',
      },
      'scaling-works': {
      ...
      'kyc-required': {
        answer: 'No KYC is required to register or trade. KYC is required by Vanta only before your first payout. Vanta (not HyperFunded) collects and processes this identity verification through its provider — no trading history or bank details required.',
      },
      'why-kyc': {
        answer: 'Payout KYC is a compliance requirement applied by Vanta for USDC distribution (AML and sanctions screening) before any transfer. HyperFunded does not handle KYC or payouts — Vanta does. It has no bearing on your ability to take the Challenge or trade.',
      },
      'what-built-on': {
      ...
      'fee-refundable': {
        answer: 'Registration fees are set, collected, and processed by Vanta. Refund eligibility, if any, is governed by Vanta’s Offer Terms and Terms of Service. HyperFunded does not collect payments or handle refunds.',
      },
      'other-fees': {
        answer: 'Fees are set and collected by Vanta. See Vanta’s Offer Terms for the current fee schedule. HyperFunded does not set pricing or process payments.',
      },
      'retry-challenge': {
  ...
  beanstock: {
    ...
    poweredBy: { name: 'Hyperscaled', url: 'https://hyperscaled.trade' },
    pricingTiers: [
      { id: 'free', name: '$1K Account', accountSize: '$1,000', launchPrice: 0, standardPrice: 0, profitTarget: '10%', profitTargetAmount: '$100', maxDrawdown: '5%', maxDrawdownAmount: '$50', profitSplit: '100%', payoutCycle: 'Monthly', scalingPath: 'None', timeLimit: 'None', cta: 'Try for Free', popular: false },
...
export function brandifyText(text, brand) {
  ...
  // Compliance safety-net for brands carrying a compliance config (HyperFunded).
  // Catches banned-term leakage in shared copy that isn't covered by an explicit
  // override. High-risk answers are fully recharacterized via brand.faqOverrides;
  // this only swaps clearly-safe residual phrasing.
  if (brand.compliance) {
    result = result
