...
const BRANDS = {
  ...
  jollygreen: {
    ...
    parentSite: { label: 'Back to Jolly Green Investor', url: 'https://jollygreeninvestor.com' },
    heroEyebrow: 'Built on Hyperliquid · Powered by Hyperscaled',
    heroSub: 'Trade with more capital without risking your own stack. Keep 100% of your profits and grow your account to\u00a0$2.5M. Built on Jolly Green Investor, the most advanced decentralized prop trading infrastructure in the world. Powered by Hyperscaled.',
