...
export const BUYING_POWER_BY_SIZE = [
  { size: '$5,000',   challenge: '2',  funded: '2' },
  { size: '$10,000',  challenge: '2',  funded: '2' },
  { size: '$25,000',  challenge: '2',  funded: '2' },
  { size: '$50,000',  challenge: '2',  funded: '2' },
  { size: '$100,000', challenge: '2',  funded: '2' },
...
export const LEVERAGE_LIMITS = [
  { tier: 'Tier 1', positional: '0.5x', portfolio: '1x' },
  { tier: 'Tier 2', positional: '1x',   portfolio: '2x' },
  { tier: 'Tier 3', positional: '1.5x', portfolio: '3x' },
]
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: 'Hyperscaled expresses leverage as buying power — how much of your account balance you can deploy per trading pair and across the portfolio at once. During the challenge, every account size uses Tier 2 (1x per trading pair, 2x portfolio). On a funded account, $5K\u2013$100K use Tier 2 (1x per trading pair, 2x portfolio), and accounts scaled to $200K\u2013$400K use Tier 3 (1.5x per trading pair, 3x portfolio). All limits are enforced automatically by the\u00a0platform.',
      },
      {
        id: 'trading-fees',
        question: 'What fees do I pay to trade?',
        answer: 'Transaction fees are 0.05% (5 bps) per trade. Bid-ask spread, slippage, and funding rates all come directly from Hyperliquid — funding is charged every 8 hours to both long and short positions. No other fees\u00a0apply.',
      },
      {
        id: 'trading-pairs',
