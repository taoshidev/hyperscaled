...
export const FEE_RULES = [
  ...
  { rule: 'Funding Fees', parameter: 'Based on Hyperliquid — charged every 8 hours to both long and short positions' },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: 'Transaction fees are 0.05% (5 bps) per trade. Bid-ask spread, slippage, and funding rates all come directly from Hyperliquid — funding is charged every 8 hours to both long and short positions. There are no swap fees, no borrow fees, and no interest charges on borrowed\u00a0cash.',
      },
      {
        id: 'trading-pairs',
