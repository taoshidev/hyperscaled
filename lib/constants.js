    ...
    items: [
      {
        ...
        answer: 'Hyperscaled is a permissionless funded trading platform built natively on Hyperliquid. You trade on Hyperliquid with your own wallet, and Hyperscaled evaluates your performance against a simulated funded account. Pass the challenge and you receive USDC performance rewards — automatically, onchain, every 7\u00a0days.',
      },
      {
        id: 'create-account',
      ...
      },
      {
        ...
        answer: 'You need at least $1,000 in your Hyperliquid account to trade. You also pay a one-time USDC registration fee to enter the challenge ($149–$449 during launch\u00a0pricing).',
      },
      {
    ...
    items: [
      {
        ...
        answer: 'The profit target is removed — there\'s no target to hit on funded accounts. Your drawdown limit increases to 8% (from 5% during the challenge). You trade in 7-day cycles and receive USDC payouts at the end of each cycle based on your realized\u00a0profits.',
      },
      {
        id: 'when-paid',
