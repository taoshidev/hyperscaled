...
export const NETWORK_STATS = [
  ...
  { value: '$400K', label: 'Max Account Size', description: 'Top-tier scaled capital available through performance scaling' },
...
export const EVAL_RULES = [
  ...
  { rule: 'Tradeable Pairs', parameter: 'All Hyperliquid tokens with a 30-day mean daily volume in USD of at least $2M — list updates dynamically' },
]
...
export const BUYING_POWER_BY_SIZE = [
  { size: '$5,000',   challenge: '1',  funded: '2' },
  { size: '$10,000',  challenge: '1',  funded: '2' },
  { size: '$25,000',  challenge: '1',  funded: '2' },
  { size: '$50,000',  challenge: '1',  funded: '2' },
  { size: '$100,000', challenge: '1',  funded: '2' },
  { size: '$200,000', challenge: '—',  funded: '3' },
  { size: '$300,000', challenge: '—',  funded: '3' },
  { size: '$400,000', challenge: '—',  funded: '3' },
]

export const LEVERAGE_LIMITS = [
  { tier: '1 (base)',                   positional: '0.5x', portfolio: '1x' },
  { tier: '2 (2x base in most cases)',  positional: '1x',   portfolio: '2x' },
  { tier: '3 (3x base in most cases)',  positional: '1.5x', portfolio: '3x' },
]

// ── Spread, Fees & Slippage ──

export const FEE_RULES = [
  { rule: 'Bid-Ask Spread', parameter: 'From Hyperliquid' },
  { rule: 'Transaction Fees', parameter: '0.05% (or 5 bps)' },
  { rule: 'Slippage', parameter: 'Based on Hyperliquid orderbook' },
  { rule: 'Funding Fees', parameter: '10.95% annualized, charged every 8 hours (to both long and short positions)' },
  { rule: 'Swap Fees', parameter: 'None' },
  { rule: 'Borrow Fees', parameter: 'None' },
  { rule: 'Interest on Borrowed Cash', parameter: 'None' },
]
    ...
    items: [
      {
        ...
        answer: 'Select an account size (free $1K, or paid $5K, $10K, $25K, $50K, or $100K), pay the one-time registration fee, and start trading on Hyperliquid. Hyperscaled reads your public trade data and mirrors it into a simulated scaled account. Hit a 10% profit target while keeping your daily drawdown under 5% to\u00a0pass.',
      },
      {
        id: 'time-limit',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: 'All Hyperliquid perpetuals with a 30-day mean daily volume in USD of at least $2M. The list updates dynamically as liquidity on Hyperliquid\u00a0shifts.',
      },
      {
        id: 'leverage-buying-power',
        question: 'How much leverage do I have?',
        answer: 'Hyperscaled expresses leverage as buying power — how much of your account balance you can deploy per single position and across the portfolio at once. During the challenge, every account size uses the base tier (0.5x per position, 1x portfolio). On a funded account, $5K\u2013$100K use tier 2 (1x per position, 2x portfolio), and accounts scaled to $200K\u2013$400K use tier 3 (1.5x per position, 3x portfolio). All limits are enforced automatically by the\u00a0platform.',
      },
      {
        id: 'trading-fees',
        question: 'What fees do I pay to trade?',
        answer: 'Transaction fees are 0.05% (5 bps) per trade. Bid-ask spread and slippage come directly from the Hyperliquid orderbook. Funding fees on open positions are 10.95% annualized, charged every 8 hours to both long and short positions. There are no swap fees, no borrow fees, and no interest charges on borrowed\u00a0cash.',
      },
      {
        id: 'trading-pairs',
        question: 'What pairs are available to trade?',
        answer: 'Tradeable pairs on the Hyperscaled challenge dynamically update. We allow all tokens on Hyperliquid with a 30-day mean daily volume in USD of at least 2 million\u00a0dollars.',
      },
    ],
  },
]
