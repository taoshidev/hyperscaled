    ...
    items: [
      {
        ...
        answer: 'Hyperscaled is a permissionless funded trading platform built natively on Hyperliquid. You trade on Hyperliquid with your own wallet, and Hyperscaled evaluates your performance against a simulated funded account. Pass the challenge and you receive USDC performance rewards — automatically, onchain,\u00a0monthly.',
      },
      {
        id: 'create-account',
    ...
    items: [
      {
        ...
        answer: 'The profit target is removed — there\'s no target to hit on funded accounts. Your drawdown limit increases to 8% (from 5% during the challenge). You receive USDC payouts monthly based on your realized\u00a0profits.',
      },
      {
        id: 'when-paid',
        question: 'When and how do I get paid?',
        answer: 'At the end of each monthly trading cycle, your payout is calculated automatically and sent in USDC to your connected wallet. No manual request required. No withdrawal fees. Every payout is verifiable\u00a0onchain.',
      },
      {
        id: 'profit-split',
      ...
      },
      {
        ...
        answer: 'No. Once funded, you receive USDC rewards based on any realized profits during the monthly cycle. There is no minimum profit\u00a0target.',
      },
      {
        id: 'scaling-works',
