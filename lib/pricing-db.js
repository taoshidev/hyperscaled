...
const TIER_DISPLAY_META = {
  5000:   { id: 'tier-1', standardPrice: 79,  scalingPath: 'Up to $100K', popular: false, cta: 'Start $5K Challenge'   },
  10000:  { id: 'tier-2', standardPrice: 139, scalingPath: 'Up to $100K', popular: false, cta: 'Start $10K Challenge'  },
  25000:  { id: 'tier-3', standardPrice: 299, scalingPath: 'Up to $100K', popular: false, cta: 'Start $25K Challenge'  },
  50000:  { id: 'tier-4', standardPrice: 549, scalingPath: 'Up to $100K', popular: false, cta: 'Start $50K Challenge'  },
  100000: { id: 'tier-5', standardPrice: 999, scalingPath: 'Up to $2.5M', popular: true,  cta: 'Start $100K Challenge' },
}
