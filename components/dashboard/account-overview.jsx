...
export function AccountOverview({ dashboard }) {
  ...
  const totalPnl = account_size_data?.total_realized_pnl != null
    ? account_size_data.total_realized_pnl
    : (account_size_data?.balance != null && account_size_data?.account_size != null)
