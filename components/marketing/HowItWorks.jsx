...
export default function HowItWorks({ tiers = [] }) {
  ...
  const steps = [
    ...
    },
    {
      ...
      body: `Hit the 10% profit target to pass the ${brand.name} Challenge and activate your ${brand.id === 'beanstock' ? 'funded' : 'scaled'} account immediately. Payouts are delivered to your wallet every 30 days, and you keep 100% of everything you\u00a0earn.`,
      mockup: <PayoutMockup />,
    },
  ]
      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl tracking-tighter leading-none font-bold max-w-2xl text-balance">
            ...
            <span className="text-zinc-500">Earn a {brand.id === 'beanstock' ? 'funded' : 'scaled'} trading&nbsp;account.</span>
          </h2>
        </motion.div>
