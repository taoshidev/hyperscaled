...
const features = [
  ...
  },
  {
    ...
    // Beanstock + other compliance brands: clarify payee (Vanta) on the pay-in side
    // and frame the pay-out side as performance-based rewards.
    ...
    // Hyperstack (bitcast): trader-first pay-in copy.
    hyperstackBody: 'Pay your registration in USDC, and receive performance-based rewards in USDC. Direct to your wallet and verifiable\u00a0onchain.',
    span: 'md:col-span-5',
    large: false,
    extra: (
            ...
            return (
              ...
              >
                ...
                <div className="relative">
                  ...
                  <p className="text-sm text-zinc-400 leading-relaxed [text-wrap:pretty]">{brandifyText(brand.id === 'bitcast' && feat.hyperstackBody ? feat.hyperstackBody : (brand.compliance && feat.bitcastBody ? feat.bitcastBody : feat.body), brand)}</p>
                  {feat.extra}
                </div>
              </motion.div>
            )
