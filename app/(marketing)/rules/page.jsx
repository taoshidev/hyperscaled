...
export const metadata = buildMetadata({
  ...
  ogDescription:
    'Every challenge and funded account rule in one place. 10% profit target, 5% drawdown limit, 100% profit split, monthly USDC payouts. No discretionary overrides. Ever.',
  path: '/rules',
})
