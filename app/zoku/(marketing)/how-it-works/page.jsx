...
export const metadata = buildMetadata({
  title: 'How It Works — Zoku Scaled Trading',
  description:
    'See exactly how Zoku works. Connect your wallet, trade on Hyperliquid, pass the challenge, and keep 100% of your monthly USDC payouts.',
  ogTitle: 'How Zoku Works — Trade on Hyperliquid, Get Funded, Keep 100%',
  ogDescription:
...
const HOW_TO_SCHEMA = {
  ...
  "@type": "HowTo",
  name: "How to get a scaled trading account on Zoku",
  description:
...
export default async function ZokuHowItWorks() {
  return (
    <>
