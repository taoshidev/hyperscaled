...
export const metadata = buildMetadata({
  ...
  ogTitle: "Start Your Challenge — Zoku Scaled Trading",
  ogDescription:
...
const getCachedRegisterMinerData = unstable_cache(
  ...
  ["zoku-register-miner-zoku"],
  {
    revalidate: 60,
    tags: ["pricing-tiers", "pricing-tiers:zoku"],
  },
)

export default async function ZokuRegisterPage() {
