...
export const metadata = buildMetadata({
  ...
  ogTitle: "Start Your Challenge — Jolly Green Investor Scaled Trading",
  ogDescription:
    "Choose from $5K to $100K. One-time USDC fee. Pass the challenge. Keep 100% of your profits.",
  path: "/jollygreen/register",
  brand: "jollygreen",
})

export const dynamic = "force-dynamic"

const MINER_SLUG = "jollygreen"
...
const getCachedRegisterMinerData = unstable_cache(
  ...
  ["jollygreen-register-miner-jollygreen"],
  {
    revalidate: 60,
    tags: ["pricing-tiers", "pricing-tiers:jollygreen"],
  },
)

export default async function JollyGreenRegisterPage() {
  ...
  return (
    <RegistrationFlow
      ...
      logoAlt="Jolly Green Investor"
      homeHref="https://jollygreeninvestor.com"
    />
  )
}
