...
export const metadata = buildMetadata({
  title: 'How It Works — Jolly Green Investor Scaled Trading',
  description:
    'See exactly how Jolly Green Investor works. Connect your wallet, trade on Hyperliquid, pass the challenge, and keep 100% of your monthly USDC payouts.',
  ogTitle: 'How Jolly Green Investor Works — Trade on Hyperliquid, Get Funded, Keep 100%',
  ogDescription:
    'No API keys. No custody. Register, trade on Hyperliquid, pass the 1-step challenge, and collect 100% of your profits monthly.',
  path: '/jollygreen/how-it-works',
  brand: 'jollygreen',
})
...
const HOW_TO_SCHEMA = {
  ...
  "@type": "HowTo",
  name: "How to get a scaled trading account on Jolly Green Investor",
  description:
...
export default async function JollyGreenHowItWorks() {
