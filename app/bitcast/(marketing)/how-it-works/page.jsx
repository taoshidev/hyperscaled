...
export const metadata = buildMetadata({
  title: 'How It Works — Bitcast Scaled Trading',
  description: 'See exactly how Bitcast works. Connect your wallet, trade on Hyperliquid, pass the challenge, and keep 100% of your monthly USDC payouts.',
  ogTitle: 'How Bitcast Works — Trade on Hyperliquid, Get Funded, Keep 100%',
  ogDescription: 'No API keys. No custody. Register, trade on Hyperliquid, pass the 1-step challenge, and collect 100% of your profits monthly.',
...
const HOW_TO_SCHEMA = {
  ...
  "@type": "HowTo",
  name: "How to get a scaled trading account on Bitcast",
